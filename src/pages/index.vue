 ...
 * - Khi PASSWORD thay đổi, tất cả client sẽ phải nhập lại, kể cả khi cookie còn hạn.
 */
    ...
    <div v-if="!isUnlocked" class="password-gate">
      <div class="password-gate-card">
        ...
        <p class="password-gate-subtitle">
          Trang quản trị yêu cầu mật khẩu. Mật khẩu sẽ được ghi nhớ trong 1 năm trên thiết bị này, trừ khi admin đổi mật khẩu.
        </p>
        <form
